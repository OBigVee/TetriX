package com.example.tetrix.models;
...
public class Block {
    ...
    //private final Object FieldConstants;
    ...
    /**
     * @NonNull is an annotation provided by android application framework which
     * implies that a field, parameter or method can never return null.
     */
    @NonNull
    ...
    public final int getFrameCount(){return Shape.values()[shapeIndex].getFrameCount();}
